...
<script>
    $(document).ready(function () {
        $('select[name="Grade_id"]').on('change', function () {
            ...
            if (Grade_id) {
                $.ajax({
                    url: "{{ URL::to('student/classes') }}/" + Grade_id,
                    type: "GET",
                    dataType: "json",
    ...
    $(document).ready(function () {
        $('select[name="Classroom_id"]').on('change', function () {
            ...
            if (Classroom_id) {
                $.ajax({
                    url: "{{ URL::to('student/sections')}}/" + Classroom_id,
                    type: "GET",
                    dataType: "json",
                    success: function (data) {
    ...
    $(document).ready(function () {
        $('select[name="Grade_id_new"]').on('change', function () {
            ...
            if (Grade_id_new){
                $.ajax({
                    url: "{{ URL::to('student/classes') }}/" + Grade_id_new,
                    type: "GET",
                    dataType: "json",
                    success: function (data) {
    ...
    $(document).ready(function () {
        $('select[name="Classroom_id_new"]').on('change', function () {
            ...
            if (Classroom_id_new) {
                $.ajax({
                    url: "{{ URL::to('student/sections') }}/" + Classroom_id_new,
                    type: "GET",
                    dataType: "json",
                    success: function (data) {
