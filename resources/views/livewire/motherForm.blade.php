...
<div style="display: none" class="row setup-content" id="step-2">
    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            @if($updateMode)
            <button class="btn btn-success btn-sm mr-2 ml-2 nextBtn btn-lg pull-right" type="button" wire:click="secondStepedit">{{trans('Parent_trans.Next')}}</button>
            @else
            <button class="btn btn-success btn-sm mr-2 ml-2 nextBtn btn-lg pull-right" type="button" wire:click="secondStepSubmit">{{trans('Parent_trans.Next')}}</button>
            @endif
