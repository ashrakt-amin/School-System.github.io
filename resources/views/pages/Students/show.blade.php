                ...
                <div class="card-body">
                    <div class="tab nav-border">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-02-tab" data-toggle="tab" href="#profile-03" role="tab" aria-controls="profile-02" aria-selected="false">Fees</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <table class="table center-aligned-table mb-0 table table-hover" style="text-align:center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style='text-align:center;vertical-align:middle'>
                                                ...
                                                <td>{{$attachment->body}}</td>
                                                <td>{{$attachment->created_at->diffForHumans()}}</td>
                                                <td colspan="2">
                                                    <a class="btn btn-outline-info btn-sm" href="{{route('Download_attachment',[$attachment->imageable->name, $attachment->body])}}" role="button"><i class="fas fa-download"></i>&nbsp; {{trans('Students_trans.Download')}}</a>
                            ...
                            <div class="tab-pane fade" id="profile-03" role="tabpanel" aria-labelledby="home-02-tab">
                                <table class="table table-striped table-hover" style="text-align:center">
                                    <tbody>
                                        <tr>
