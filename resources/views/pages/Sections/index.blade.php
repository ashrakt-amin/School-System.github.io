														...
														<tbody>
															...
															<tr>
																...
																<td>
																	...
																	<a href="#" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#edit{{ $section->id }}">{{ trans('Sections_trans.Edit') }}</a>
																	<a href="#" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#delete{{ $section->id }}">{{ trans('Sections_trans.Delete') }}</a>
																</td>
															</tr>
																	...
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			...
																			<form action="{{ route('section.update',$section->id ) }}" method="POST">
																				...
																				<div class="row">
																					<div class="col">
																						<input type="text" name="ar_name" class="form-control" value="{{ $section->getTranslation('name', 'ar') }}">
																					</div>

																					<div class="col">
																						<input type="text" name="en_name" class="form-control" value="{{ $section->getTranslation('name', 'en') }}">
																					</div>
								...
								<form action="{{ route('section.store') }}" method="POST">
									...
									<div class="row">
										<div class="col">
											...
											<input type="text" name="ar_name" class="form-control" placeholder="{{ trans('Sections_trans.Section_name_ar') }}">
										</div>

										<div class="col">
											<input type="text" name="en_name" class="form-control" placeholder="{{ trans('Sections_trans.Section_name_en') }}">
										</div>
